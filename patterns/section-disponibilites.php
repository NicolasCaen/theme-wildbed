...
<!-- wp:group {"metadata":{"name":"Disponibilites"},"align":"","className":"align-ultra align-ultrawide","layout":{"type":"constrained","contentSize":"100%"}} -->
...
<div id="disponibilites" class="wp-block-group"><!-- wp:shortcode -->
<?php 
if (!$is_editor) {
