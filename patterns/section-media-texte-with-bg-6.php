 ...
 * Slug: ng1-base/section-media-texte-with-bg-6
 * Categories: media,text
 * Keywords: text, media
 * Block Types: core/group
 */
?>
<!-- wp:group {"metadata":{"name":"Section Media Texte With BG 6"},"align":"full","className":"section-media-texte-with-bg-6","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull section-media-texte-with-bg-6"><!-- wp:group {"metadata":{"name":"Section | Wrapper"},"align":"","className":"section-media-texte-with-bg-6__wrapper align-ultrawide is-style-style-2","style":{"border":{"radius":{"topLeft":"var:preset|border-radius|s","topRight":"var:preset|border-radius|s","bottomLeft":"var:preset|border-radius|s","bottomRight":"var:preset|border-radius|s"}}},"layout":{"type":"constrained"}} -->
